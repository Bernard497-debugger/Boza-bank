...
def get_app_data():
    ...
    balance, total_revenue, history = "0.00", 0.0, []
    try:
        ...
        for tx in t_res.json().get('transaction_details', []):
            ...
            if val > 0:
                total_revenue += val
                history.append({"type": "Incoming", "amount": val, "date": info.get('transaction_initiation_date', '')[:10]})
    except: pass
...
<head>
    ...
    <style>
        ...
        body { margin: 0; background: var(--bg); font-family: sans-serif; color: white; display: flex; justify-content: center; align-items: center; min-height: 100vh; }
...
<body>
    <div class="app-container">
        <div id="success-overlay">
            ...
            <p style="opacity: 0.5; font-size: 14px;">The transaction has been captured successfully.</p>
        ...
        <div class="balance-card">
            <div style="opacity: 0.4; font-size: 10px; letter-spacing: 1px;">ACCOUNT BALANCE</div>
        ...
        <div id="dep-sec" class="action-sec active">
            ...
            <span class="btn-desc">Use this to add funds yourself via PayPal.</span>
        </div>
        <div id="rec-sec" class="action-sec">
            ...
            <span class="btn-desc">Securely process payments from others via Card.</span>
        </div>
        <div class="history">
